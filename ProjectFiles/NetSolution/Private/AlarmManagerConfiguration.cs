...
[MapType(NamespaceUri = "OptimateDemoProject", Guid = "e1a5f210cf6255f53bfee7957283a940")]
public class AlarmManagerConfiguration : UAObject
{
#region Children properties
    ...
    public object Inhibit
    {
        get
        {
            return (object)Refs.GetVariable("Inhibit").Value.Value;
        }
        set
        {
